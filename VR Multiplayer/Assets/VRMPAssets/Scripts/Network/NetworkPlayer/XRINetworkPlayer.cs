...
namespace XRMultiplayer
{
    ...
    public class XRINetworkPlayer : NetworkBehaviour
    {
        ...
        /// </summary>
        public Transform m_LeftHandOrigin, m_RightHandOrigin, m_HeadOrigin;
        ...
        {
            //This suprisingly does matter and cause problems regarding movement with custom models you need to do the entire rigging process or do it alternatively like this:
